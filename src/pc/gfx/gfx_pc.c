    ...
    for (size_t i = 0; i < n_vertices; i++, dest_index++) {
        ...
        if (rsp.geometry_mode & G_LIGHTING) {
            ...
            if (gCurrentObject != NULL && gMarioStates[0].marioBodyState != NULL) {
                ...
                if (cc_mario_cap) {
                    show_cap = true;
                    r = (0 == 0) ? defaultColorHat.red[1] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorHat.green[1] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorHat.blue[1] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_overalls) {
                    show_overalls = true;
                    r = (0 == 0) ? defaultColorOveralls.red[1] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorOveralls.green[1] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorOveralls.blue[1] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_gloves) {
                    show_gloves = true;
                    r = (0 == 0) ? defaultColorGloves.red[1] : gNetworkPlayers[0].overridePalette.parts[2][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorGloves.green[1] : gNetworkPlayers[0].overridePalette.parts[2][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorGloves.blue[1] : gNetworkPlayers[0].overridePalette.parts[2][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_shoes) {
                    show_shoes = true;
                    r = (0 == 0) ? defaultColorShoes.red[1] : gNetworkPlayers[0].overridePalette.parts[3][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorShoes.green[1] : gNetworkPlayers[0].overridePalette.parts[3][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorShoes.blue[1] : gNetworkPlayers[0].overridePalette.parts[3][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_skin) {
                    show_skin = true;
                    r = (0 == 0) ? defaultColorSkin.red[1] : gNetworkPlayers[0].overridePalette.parts[5][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorSkin.green[1] : gNetworkPlayers[0].overridePalette.parts[5][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorSkin.blue[1] : gNetworkPlayers[0].overridePalette.parts[5][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_hair) {
                    show_hair = true;
                    r = (0 == 0) ? defaultColorHair.red[1] : gNetworkPlayers[0].overridePalette.parts[4][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorHair.green[1] : gNetworkPlayers[0].overridePalette.parts[4][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorHair.blue[1] : gNetworkPlayers[0].overridePalette.parts[4][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_shirt) {
                    show_shirt = true;
                    r = (0 == 0) ? sparkColorShirt.red[1] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorShirt.green[1] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorShirt.blue[1] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_shoulders) {
                    show_shoulders = true;
                    r = (0 == 0) ? sparkColorShoulders.red[1] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorShoulders.green[1] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorShoulders.blue[1] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_arms) {
                    show_arms = true;
                    r = (0 == 0) ? sparkColorArms.red[1] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorArms.green[1] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorArms.blue[1] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_pelvis) {
                    show_pelvis = true;
                    r = (0 == 0) ? sparkColorPelvis.red[1] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorPelvis.green[1] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorPelvis.blue[1] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_thigh) {
                    show_thigh = true;
                    r = (0 == 0) ? sparkColorThigh.red[1] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorThigh.green[1] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorThigh.blue[1] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                if (cc_mario_calf) {
                    show_calf = true;
                    r = (0 == 0) ? sparkColorCalf.red[1] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? sparkColorCalf.green[1] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? sparkColorCalf.blue[1] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
                ...
                if (cc_creator_sideburn) {
                    show_hair = true;
                    r = (0 == 0) ? defaultColorHair.red[1] * 2 : gNetworkPlayers[0].overridePalette.parts[4][0] * gMarioStates[0].marioBodyState->shadeR / 255.0f;
                    g = (0 == 0) ? defaultColorHair.green[1] * 2 : gNetworkPlayers[0].overridePalette.parts[4][1] * gMarioStates[0].marioBodyState->shadeG / 255.0f;
                    b = (0 == 0) ? defaultColorHair.blue[1] * 2 : gNetworkPlayers[0].overridePalette.parts[4][2] * gMarioStates[0].marioBodyState->shadeB / 255.0f;
                }
            }
            ...
            for (int32_t i = 0; i < rsp.current_num_lights - 1; i++) {
                ...
                if (intensity > 0.0f) {
                    if (gCurrentObject != NULL && gMarioStates[0].marioBodyState != NULL) {
                        if (cc_mario_cap) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_overalls) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_gloves) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[2][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[2][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[2][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_shoes) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[3][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[3][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[3][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_skin) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[5][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[5][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[5][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_hair) {
                            r += intensity * (gNetworkPlayers[0].overridePalette.parts[4][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * (gNetworkPlayers[0].overridePalette.parts[4][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * (gNetworkPlayers[0].overridePalette.parts[4][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        // SPARK
                        } else if (cc_mario_shirt) {
                            r += intensity * ((0 == 0) ? sparkColorShirt.red[0] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorShirt.green[0] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorShirt.blue[0] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_shoulders) {
                            r += intensity * ((0 == 0) ? sparkColorShoulders.red[0] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorShoulders.green[0] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorShoulders.blue[0] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_arms) {
                            r += intensity * ((0 == 0) ? sparkColorArms.red[0] : gNetworkPlayers[0].overridePalette.parts[1][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorArms.green[0] : gNetworkPlayers[0].overridePalette.parts[1][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorArms.blue[0] : gNetworkPlayers[0].overridePalette.parts[1][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_pelvis) {
                            r += intensity * ((0 == 0) ? sparkColorPelvis.red[0] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorPelvis.green[0] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorPelvis.blue[0] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_thigh) {
                            r += intensity * ((0 == 0) ? sparkColorThigh.red[0] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorThigh.green[0] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorThigh.blue[0] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        } else if (cc_mario_calf) {
                            r += intensity * ((0 == 0) ? sparkColorCalf.red[0] : gNetworkPlayers[0].overridePalette.parts[0][0] * gMarioStates[0].marioBodyState->lightR / 255.0f);
                            g += intensity * ((0 == 0) ? sparkColorCalf.green[0] : gNetworkPlayers[0].overridePalette.parts[0][1] * gMarioStates[0].marioBodyState->lightG / 255.0f);
                            b += intensity * ((0 == 0) ? sparkColorCalf.blue[0] : gNetworkPlayers[0].overridePalette.parts[0][2] * gMarioStates[0].marioBodyState->lightB / 255.0f);
                        // Extras
