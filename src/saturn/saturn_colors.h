...
extern struct ColorTemplate sparkColorPelvis; 
extern struct ColorTemplate sparkColorThigh;
extern struct ColorTemplate sparkColorCalf;

extern bool show_cap, show_overalls, show_gloves, show_shoes, show_skin, show_hair;
extern bool show_shirt, show_shoulders, show_arms, show_pelvis, show_thigh, show_calf;
...
class ColorCode {
    public:
        ...
        void ParseGameShark() {
            ...
            if (spark_enabled && active_saturn_model_index != -1) {
                gameshark += "\n";
                ...
                std::string col10 = HexifyColorTemplate(sparkColorPelvis);
                std::string col11 = HexifyColorTemplate(sparkColorThigh);
                std::string col12 = HexifyColorTemplate(sparkColorCalf);
...
extern void PasteGameShark(std::string, bool);
